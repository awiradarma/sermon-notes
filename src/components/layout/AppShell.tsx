...
export function AppShell({ 
  ...
  return (
    <div className="flex flex-col h-[100dvh] overflow-hidden bg-background text-foreground">
      ...
      {/* Main Content Area */}
      <main className={`flex-1 flex flex-col min-h-0 bg-muted/20 ${isKeyboardVisible ? 'pb-0' : 'pb-20'} md:pb-6 relative w-full ${activeTab === 'graph' ? '' : 'max-w-5xl mx-auto md:mt-4 md:px-4'}`}>
        {children}
      </main>
